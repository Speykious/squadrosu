...
public class SquadrosuSliderBar<T> : SliderBar<T>
    where T : struct, IEquatable<T>, IComparable<T>, IConvertible
{
    ...
    protected readonly SquadrosuNub Nub;
    ...
    public SquadrosuSliderBar()
    {
        Height = SquadrosuNub.HEIGHT;
        RangePadding = SquadrosuNub.EXPANDED_SIZE / 2;
    ...
    private void load(AudioManager audio)
    {
        ...
        AccentColour = SquadrosuColor.SliderGray;
        BackgroundColour = SquadrosuColor.SliderGray.Opacity(.5f);
    }
